...
import { CheckCircle2, Clock, FileText, ExternalLink, ArrowLeft, BookOpen, ScrollText, Quote, AlertTriangle, ShieldAlert, PenLine, Upload, Info } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <section className="space-y-4">
        <h2 className="text-lg font-semibold tracking-tight flex items-center gap-2">
          ...
          Appendix – An excerpt of an academic journal article
        </h2>
        ...
        <Card className="border-primary/20">
          <CardHeader className="pb-2">
            <CardTitle className="text-base font-semibold">Facial recognition technologies in education</CardTitle>
          </CardHeader>
          <CardContent>
