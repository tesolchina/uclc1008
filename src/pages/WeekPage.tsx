...
export const WeekPage = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid gap-4 md:grid-cols-[minmax(0,2fr)_minmax(0,1.4fr)] lg:gap-6">
        ...
        <div className="space-y-4">
          <LessonAiTutor weekTitle={week.title} theme={week.theme} aiPromptHint={week.aiPromptHint} />
        </div>
      </section>
    </div>
  );
